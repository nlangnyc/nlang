...
import org.scalatra.json._ //added

trait FunStack extends ScalatraServlet with ScalateSupport{
...
trait JsonStack extends ScalatraServlet with JacksonJsonSupport{
  before(){
